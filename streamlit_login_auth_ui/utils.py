...
def send_passwd_in_email(auth_token: str, username_forgot_passwd: str, email_forgot_passwd: str, company_name: str, random_password: str) -> None:
    ...
    message={
        ...
        "content": {
        "title": company_name + ": Solicitação de nova senha!",
        "body": "✌ Olá! " + username_forgot_passwd + "," + "\n" + "\n" + "Sua senha temporária é: " + random_password  + "\n" + "\n" + "{{info}}"
        },
        "data":{
        "info": "🔒⌛ Por favor, resete sua senha o quanto antes, por razões de segurança."
        }
    }
    )
